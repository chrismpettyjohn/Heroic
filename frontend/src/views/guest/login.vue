<template>
    <div>
      <loading v-if="state.loading" class="login-area">We are logging you in...</loading>
      <div v-if="!state.loading" class="login-area">
        ...
        <form @submit.prevent="login()">
          ...
          <div class="login_group">
            <router-link :to="{ name: 'Guest.Register' }" class="login_link">Or Join Today...</router-link>
          </div>
        </form>
      </div>
    </div>  
