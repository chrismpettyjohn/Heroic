        ...
        <nav class="news-category__navigation">
          <ul class="news-category__list">
            <li class="news-category__item">
              <router-link :to="{ name: 'Community.News.Latest' }" class="news-category__link">All</router-link>
            </li>
            <li v-for="cata in categories" :key="cata.id" class="news-category__item">
              <router-link :to="{ name: 'Community.News.Category', params: { id: cata.id }}" :class="{'news-category__link--active': category.id===cata.id}" class="news-category__link">{{ cata.title }}</router-link>
            </li>
          </ul>
        </nav>
      </header>
      <!-- Articles -->
      <article v-for="article in category.articles" :key="article.id" class="news-header">
